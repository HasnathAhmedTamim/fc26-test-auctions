...
export function PlayerCard({ player }: { player: Player }) {
  ...
  return (
    <div className="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 transition hover:-translate-y-1 hover:border-emerald-400/40">
      ...
      <Link
        ...
        className="absolute right-3 top-3 rounded-full border border-white/20 bg-black/60 px-3 py-1 text-xs font-semibold text-white backdrop-blur-sm transition hover:border-emerald-400/50 hover:bg-emerald-500/20 hover:text-emerald-200"
      >
        Compare
      </Link>
    </div>
